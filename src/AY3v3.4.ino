...
const int tp[] = { //Frequencies related to MIDI note numbers
...
void setup() {   
    ...
    if (masterChannel == 0 || masterChannel > 16) masterChannel = 1;
    ...
    //sysex receive
    if (!digitalRead(5)) receiveDump();
    if (!digitalRead(6)) {} //vol
